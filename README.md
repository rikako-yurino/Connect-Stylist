...
|                  現状課題                                             |     課題改善                                                         |
| ----------------------------------------------------------------------|----------------------------------------------------------------------|
| 骨格診断やパーソナルスタイリストが注目されているにも関わらず、        |オンライン完結することで低単価を実現し、                              |
| 高単価なサービスが多いため利用者が限られている                        | サービスを受けられるユーザーの幅を広げる                             |
| --------------------------------------------------------------------- |--------------------------------------------------------------------- |
| コロナ渦においてEC化率を加速させる企業が多い中、                      |アパレルメーカーと提携することでEC販促に課題を抱えている企業のサポート|
| ネット上での接客サービスの不足感がある                                |                                                                      |
|                                                                       |                                                                      |
